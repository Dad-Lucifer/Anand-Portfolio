    ...
    <section className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <motion.div
          ...
          className="absolute bottom-20 left-20 w-20 h-20 md:w-28 md:h-28 border-4 border-secondary"
        />
        ...
        <motion.div
          ...
          className="absolute top-1/3 left-1/4 w-24 h-24 md:w-32 md:h-32 border-4 border-accent rounded-full"
        />
      </div>
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        ...
        >
          From storytelling to post-production — every project deserves cinematic precision.
        </motion.p>
